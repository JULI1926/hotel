...
<body>
    <form action="php/registro_pedido.php" method="POST" >
    	<h1>Pedido</h1><hr>
        <input type="number" name="crear_pedido_foranea" placeholder="Cedula">
    	<input type="number" name="crear_pedido_habitacion_numero" placeholder="Numero de Habitacion">    	
        <input type="text" name="crear_pedido_descripcion" placeholder="Descripcion">
        <input type="number" name="crear_pedido_costo" placeholder="Costo">        
        <br>
        <h4 class = "estado_pedido"> <br> Estado del pedido</h4>
        <br>		
		<select name="crear_pedido_estado_pedido">
